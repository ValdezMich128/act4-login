...
import 'package:valdez/firebase_options.dart';
...
class PaginaSesion extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        centerTitle: true,
        title: const Text('Sadboyz Sudaderas',
            style: TextStyle(color: Colors.white)),
        backgroundColor: const Color(0xff5482a1),
        elevation: 8,
      ),
      body: Padding(
          ...
          children: <Widget>[
            ...
            ElevatedButton(
              ...
              style: ElevatedButton.styleFrom(
                ...
                backgroundColor: const Color(0xff7195ba),
              ),
            ...
            ElevatedButton(
              ...
              style: ElevatedButton.styleFrom(
                minimumSize: const Size(340, 40),
                backgroundColor: const Color(0xff87add5),
              ),
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        backgroundColor: const Color(0xff728eab),
        elevation: 8,
      ),
      body: Center(
        child: Column(
          ...
          children: [
            Image(
                image: NetworkImage(
                    "https://raw.githubusercontent.com/ValdezMich128/Img_IOS/main/J11.jpg")),
            ...
            ElevatedButton(
              ...
              style: ElevatedButton.styleFrom(
                minimumSize: const Size(340, 40),
                backgroundColor: const Color(0xff9abce0),
              ),
